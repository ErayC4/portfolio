...
function AboutMe() {
  ...
  return (
    /*
        ...
        */
    <div>
      <p className="text-8xl text-rose-500 fugazOne">ABOUT ME</p>
      <div className="flex gap-16 pt-12">
        <div className="w-3/4">
          <p className="text-4xl fugazOne">
            Building Tomorrow's Digital Skylines: Code & Design with Expertise
          </p>
          <div className="grid grid-cols-2 gap-16 pt-8">
            <div>
              <p className="text-xl">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Laboriosam culpa, odio sequi perferendis ullam quisquam rerum
        ...
        <img
          ...
          className="object-cover h-64 w-1/4"
          alt=""
        />
      </div>
